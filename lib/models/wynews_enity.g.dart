...
wynews_enity _$wynews_enityFromJson(Map<String, dynamic> json) {
  return wynews_enity((json['BBM54PGAwangning'] as List)
      ?.map((e) => e == null
          ? null
...
Map<String, dynamic> _$wynews_enityToJson(wynews_enity instance) =>
    <String, dynamic>{'BBM54PGAwangning': instance.bBM54PGAwangning};

BBM54PGAwangning _$BBM54PGAwangningFromJson(Map<String, dynamic> json) {
